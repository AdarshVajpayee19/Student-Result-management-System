<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content" style="background:#28323b">
                            <div class="user-info closed">
                                <img src="Bnmitlogo.jpg" alt="bnm.png" class="img-circle profile-img">
                                <h6 class="title">BNMIT</h6>
                                <small class="info">since 50 years</small>
                            </div>
                            <!-- /.user-info -->
