...
<html lang="en">
    <head>
        ...
        <title>Bnmit Admin| Student Admission< </title>
...
<div class="col-sm-10">
<input type="text" name="fullanme" class="form-control" id="fullanme" required="required" autocomplete="off" placeholder="please enter name it should not consist of number.">
<span class="help-block">Eg-Adarsh ,Abhay etc</span>
</div>
</div>
